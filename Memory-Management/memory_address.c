...
int main() {
    ...
    int myAge = 43;
    printf("%p", &myAge); // Outputs 0x16d0ef3f8

    // Note: The memory address is in hexadecimal form (0x..). 
    // You will probably not get the same result in your program, as this depends on where the variable is stored on your computer.
